...
- Gestion des albums (liste, détails, création)
- Affichage des relations (utilisateur créateur, tags)
- Protection des routes par authentification

### Relations de base de données
- **One-to-Many**: Un utilisateur peut avoir plusieurs albums
- **Many-to-Many**: Un album peut avoir plusieurs tags, un tag peut être associé à plusieurs albums
...
- `user_id` (uint, nullable) - ID de l'utilisateur créateur (relation one-to-many)
- `user` (User) - Utilisateur créateur (relation)
- `tags` ([]Tag) - Tags associés (relation many-to-many)

### Tag
- `id` (uint) - Unique identifier (auto-generated by GORM)
- `name` (string) - Nom du tag (unique)
- `albums` ([]Album) - Albums associés (relation many-to-many)
...
Note: `tag_ids` est optionnel et permet d'associer des tags à l'album lors de la création.
...
- Les relations one-to-many et many-to-many sont gérées automatiquement par GORM
